...
module AttachmentMagic
  ...
  module ActMethods
    ...
    def has_attachment(options = {})
      ...
      when :none, nil
        processors = AttachmentMagic.default_processors.dup
        begin
          if processors.any?
            attachment_options[:processor] = processors.first
            processor_mod = AttachmentMagic::Processors.const_get("#{attachment_options[:processor].to_s.classify}Processor")
